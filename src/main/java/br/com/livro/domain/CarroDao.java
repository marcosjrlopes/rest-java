...
public class CarroDao extends BaseDAO {
	...
	public void save(Carro c)throws SQLException {
		...
		try {
			...
			if(c.getId() == null) {
				stmt = conn.prepareStatement("insert into carro (nome,descricao,url_foto,url_video,latitude,longitude,tipo)"
			...
			//Se inseriu le o id retornado e seter no objeto atual.
			if(c.getId() == null) {
